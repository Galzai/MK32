...
ENV PATH="/opt/esp/tools/cmake/3.16.4/bin:${PATH}"
...
ENV PATH="/opt/esp/tools/xtensa-esp32-elf/esp-2021r1-8.4.0/xtensa-esp32-elf/bin:${PATH}"
ENV PATH="/opt/esp/tools/xtensa-esp32s2-elf/esp-2021r1-8.4.0/xtensa-esp32s2-elf/bin:${PATH}"
ENV PATH="/opt/esp/tools/xtensa-esp32s3-elf/esp-2021r1-8.4.0/xtensa-esp32s3-elf/bin:${PATH}"
ENV PATH="/opt/esp/tools/riscv32-esp-elf/esp-2021r1-8.4.0/riscv32-esp-elf/bin:${PATH}"
...
ENV PATH="/opt/esp/tools/cmake/3.16.4/bin:${PATH}"
ENV PATH="/opt/esp/tools/openocd-esp32/v0.10.0-esp32-20210401/openocd-esp32/bin:${PATH}"
ENV PATH="/opt/esp/python_env/idf4.4_py3.6_env/bin:${PATH}"
